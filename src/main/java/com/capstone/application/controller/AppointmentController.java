...
public class AppointmentController 
{
	...
	public Appointment findPreviousAppointmentforNurseDoctor(@PathVariable int patientId) throws AppointmentServiceException{
	return appointmentService.findPreviousAppointmentforNurseDoctor(patientId);
	}
